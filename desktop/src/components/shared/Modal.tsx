...
export function Modal({ open, onClose, title, children, width = 560, footer }: ModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div
        className="glass-panel relative rounded-[var(--radius-xl)] max-h-[85vh] flex flex-col bg-[var(--color-surface-container-lowest)] border border-[var(--color-border)] shadow-[var(--shadow-dropdown)]"
