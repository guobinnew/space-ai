 ...
 * 当 LLM 通过 TodoWrite 工具输出任务清单时，在此组件中展示。
 */
...
export function SessionTaskBar({ todos }: Props) {
  ...
  return (
    <div className="shrink-0 px-8">
      <div className="mx-auto max-w-[860px] rounded-xl border border-[var(--color-outline-variant)]/40 bg-[var(--color-surface-container-lowest)] overflow-hidden mb-2">
