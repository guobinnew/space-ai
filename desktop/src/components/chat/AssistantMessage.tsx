...
function AgentAvatar() {
  return (
    ...
    >
      ...
      <rect x="8" y="10" width="20" height="16" rx="4" fill="none" stroke="currentColor" strokeWidth="1.5" />
      ...
      <path d="M13 24 Q18 27 23 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  );
}
...
export const AssistantMessage = memo(function AssistantMessage({
  ...
  const handleCopyImage = useCallback(async () => {
    ...
    const scrollables: Array<{ el: HTMLElement; overflow: string; overflowX: string; overflowY: string }> = [];
